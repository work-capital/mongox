defmodule Mongo.Connection do
  ...
  def insert(conn, coll, docs, opts \\ []) do
    ...
    case GenServer.call(conn, {:insert, coll, docs, opts}, 20_000) do
  ...
  def update(conn, coll, query, update, opts \\ []) do
    GenServer.call(conn, {:update, coll, query, update, opts}, 20_000)
  end

  @doc false
  def remove(conn, coll, query, opts \\ []) do
    GenServer.call(conn, {:remove , coll, query, opts}, 20_000)
  end
